<p align="center">
	...
	<b>🇺🇦 Розширення Cloudstream (Україна) — Fork</b>
</p>
<p align="center">
<img src="https://img.shields.io/github/languages/code-size/3a4oT/cloudstream-extensions-uk?style=for-the-badge"/>
<img src="https://img.shields.io/github/actions/workflow/status/3a4oT/cloudstream-extensions-uk/build.yml?style=for-the-badge"/>
<img src="https://img.shields.io/badge/Made_with-Kotlin-8051ff?style=for-the-badge&logo=kotlin"/>
</p>

## Про цей форк

Це GitHub-дзеркало оригінального проєкту [cloudstream-extensions-uk](https://codeberg.org/CakesTwix/cloudstream-extensions-uk) авторства [CakesTwix](https://codeberg.org/CakesTwix).

Автор прийняв рішення перенести розробку на платформу Codeberg. Поважаю це рішення та підтримую цей форк виключно для власних потреб. Усі права та кредити належать оригінальному автору.

**Статус:** синхронізація з upstream без змін. У майбутньому можливі власні модифікації.

| Оригінальний репозиторій | https://codeberg.org/CakesTwix/cloudstream-extensions-uk |
|--------------------------|----------------------------------------------------------|
